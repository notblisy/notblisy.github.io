/****************************************************************************
** Meta object code from reading C++ file 'ResearcherModel.hpp'
**
...
#include "../../../../../../Source/Model/Util/ResearcherModel.hpp"
...
#error "The header file 'ResearcherModel.hpp' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject ResearcherModel::staticMetaObject = { {
    QMetaObject::SuperData::link<TableModel<ResearcherState>::staticMetaObject>(),
...
void *ResearcherModel::qt_metacast(const char *_clname)
{
    ...
    return TableModel<ResearcherState>::qt_metacast(_clname);
}

int ResearcherModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = TableModel<ResearcherState>::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
