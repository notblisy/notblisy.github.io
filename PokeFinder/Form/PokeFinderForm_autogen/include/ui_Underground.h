...
public:
    ...
    void setupUi(QWidget *Underground)
    {
        ...
        gridLayout_45->addWidget(groupBoxProfile, 0, 0, 1, 3);
        ...
        gridLayout_45->addWidget(groupBoxRNGInfo, 1, 0, 1, 1);
        ...
        gridLayout_45->addWidget(groupBoxSettings, 1, 1, 1, 1);
        ...
        gridLayout_45->addWidget(groupBoxFilters, 1, 2, 1, 1);

        tableView = new TableView(Underground);
        tableView->setObjectName("tableView");

        gridLayout_45->addWidget(tableView, 2, 0, 1, 3);
